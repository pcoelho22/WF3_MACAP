					...
					<div id="carousel-example-generic" class="col-lg-12 carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<img src="<?= $this->assetUrl('img/pic4.jpg') ?>" class="img-responsive  img-rounded" alt="Image">
							...
							<div class="item">
								<img src="<?= $this->assetUrl('img/pic5.jpg') ?>" class="img-responsive  img-rounded" alt="Image">
								<div class="carousel-caption">
									<h3>Retrocar</h3>
									<p>Classic cars making history</p>
								</div>
							...
							<div class="item">
								<img src="<?= $this->assetUrl('img/alfa.jpg') ?>" class="img-responsive  img-rounded" alt="Image">
								<div class="carousel-caption">
									<h3>Retrocar</h3>
									<p>Classic cars making history</p>
								</div>
							...
							<div class="item">
								<img src="<?= $this->assetUrl('img/pic6.jpg') ?>" class="img-responsive  img-rounded" alt="Image">
								<div class="carousel-caption">
									<h3>Retrocar</h3>
									<p>Classic cars making history</p>
								</div>
							...
							<div class="item">
								<img src="<?= $this->assetUrl('img/pic7.jpg') ?>" class="img-responsive  img-rounded" alt="Image">
								<div class="carousel-caption">
									<h3>Retrocar</h3>
									<p>Classic cars making history</p>
								</div>
